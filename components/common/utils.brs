...
'** @param obj as Object file name
'** @param message as String
'** @param code as Integer [Optional]
'*************************************************************
...
'timestamp
function nowAsMilliseconds() as Object
    millseconds = now().GetMilliseconds().toStr()
    if millseconds.Len() = 0
        millseconds = "000"
    else if millseconds.Len() = 1
        millseconds = "00" + millseconds
    else if millseconds.Len() = 2
        millseconds = "0" + millseconds
    end if
    return now().asSeconds().toStr() + millseconds
end function
...
'*************************************************************
'** isString
'** @brief Determine if the given object supports the ifString interface
'*************************************************************
